# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 13:38:22 2020
...
if __name__ == "__main__":
  ...
  file_name = " "
  image_path = './retrain/test/truck'  # 测试图片文件夹
  model_file = './output_graph.pb'  # retrain.py 生成的output_graph.pb
  label_file = "./output_labels.txt"             # retrain.py 生成的output_labels.txt
  input_height = 299
  input_width = 299
  input_mean = 0
  input_std = 255
